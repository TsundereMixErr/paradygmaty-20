import l4.{*, +, -, /, createTree, eachNElement, ldzialanie, printBT, removeDuplicatesBFS, removeDuplicatesDFS, subtract}
import l4_trees_example.{tree1, tree2, tree3, tree4, tree5, tree6, treeResult1, treeResult2, treeResult3, treeResult4, treeResult5, treeResult6, treeResult7}
